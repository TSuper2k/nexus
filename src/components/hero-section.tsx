    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="relative">
          {/* Blur background cho content */}
          <div className="absolute inset-0 z-0 blur-2xl bg-gradient-to-br from-cyan-400/30 via-purple-400/20 to-transparent" />
          <div className="grid lg:grid-cols-2 gap-12 items-center relative z-10">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="grid grid-cols-2 gap-6 text-center">
                <div>
                  <div
                    className="text-3xl font-bold text-cyan-accent"
                    data-testid="stat-global-users"
                  >
                    14.6M+
                  </div>
